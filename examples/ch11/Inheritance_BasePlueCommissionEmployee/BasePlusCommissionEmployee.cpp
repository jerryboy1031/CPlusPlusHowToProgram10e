...
double BasePlusCommissionEmployee::earnings() const {
   ...
   return baseSalary + (commissionRate * grossSales); // error!
}
...
string BasePlusCommissionEmployee::toString() const {
   ...
   // derived class cannot access the base class's private data          
   output << "base-salaried commission employee: " << firstName << ' '  // error!
      << lastName << "\nsocial security number: " << socialSecurityNumber // error!
      << "\ngross sales: " << grossSales // error!
      << "\ncommission rate: " << commissionRate // error!
