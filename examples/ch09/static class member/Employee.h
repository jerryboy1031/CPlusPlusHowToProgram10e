...
private:
   ...
   // all instances of the same class share a copy of data member
   // only static const int and enum type can be initialized in class def
   // others: global namespace scope
